...
R_flip[0,0] = 1.0 #x
R_flip[1,1] = -1.0 #y img is flipped
R_flip[2,2] = -1.0 #z img is flipped
...
#set camera size as the one it was calibrated with
...
while True:
    ...
    if np.any(ids != None) and ids[0] == id_to_find:
        #-- ret = [rvec, tvec, ?]
