...
class Pipeline:
    ...
    def __init__(self):
        ...
        self.__hsv_threshold_hue = [125.17987065178028, 180.0]
        self.__hsv_threshold_saturation = [45.86330497865196, 255.0]
        self.__hsv_threshold_value = [146.76259211499055, 255.0]
        ...
        self.__find_blobs_min_area = 7000.0
